...
import { Plus, Trash2, LogOut, MessageSquare, Terminal, User } from "lucide-react";
    ...
    <div className="flex flex-col h-full bg-black border-r border-primary/20 w-[280px] flex-shrink-0">
      ...
      <div className="p-4 border-b border-primary/20">
        <div className="flex items-center gap-2 mb-6">
          <div className="w-8 h-8 bg-primary text-black flex items-center justify-center font-bold text-xl rounded-none">
            H
          </div>
